    ...
    <>
      <main>
        <section className="left">
          <h1>
            <span className="fun">EMIN</span>
            <span className="x"> - </span>
            <span className="show">RASEN</span>
          </h1>
          <p className="des">TURKMEN RAP İÑ DALISI</p>
          {/* <img
            width="150"
            height="150"
            src="/images/emin-rasen.jpg"
            alt="emin rasen"
          /> */}
          <p className="join">DALI TOPAR!</p>
        </section>
        ...
        <nav>
          <ul>
            ...
            <li>
              <a
                href="https://www.youtube.com/channel/UC8uDXae5fjlLgrlYbdL3UyQ"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span></span>
      ...
      <style jsx>{`
        main {
          ...
          background-image: url("/images/top-left-lines.svg"),
            url("/images/bottom-right-lines.svg");
        ...
        li:hover > a span:nth-of-type(1) {
          transform: translate(10px, -10px);
        }
        li:hover > a span:nth-of-type(2) {
          transform: translate(20px, -20px);
        }
        li:hover > a span:nth-of-type(3) {
          transform: translate(30px, -30px);
        }
        li:hover > a span:nth-of-type(4) {
          transform: translate(40px, -40px);
        }
        li:hover > a span:nth-of-type(5) {
